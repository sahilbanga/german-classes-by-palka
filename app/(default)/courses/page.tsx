            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="pt-32 md:pt-40">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className={'mt-5'}>
                            <h2 className="h3 text-purple-600 pb-2">Level A2</h2>
                            <p>
                        ...
                        <div className={'mt-5'}>
                            <h2 className="h3 text-purple-600 pb-2">Level B1 – Intermediate Language Use</h2>
                            <p>
                        ...
                        <div className={'mt-5'}>
                            <h2 className="h3 text-purple-600 pb-2">Level B2</h2>
                            <p>
                        ...
                        <div className={'mt-5'}>
                            <h2 className="h3 text-purple-600 pb-2">Level C1 – Advanced Language Use</h2>
                            <p>
                        ...
                        <div className={'mt-5'}>
                            <h2 className="h3 text-purple-600 pb-2">Level C2</h2>
                            <p>
